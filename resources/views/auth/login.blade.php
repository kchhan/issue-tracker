                ...
                >
                    ...
                    >
                        ...
                        <div class="flex items-center">
                            ...
                            <a
                                class="text-sm text-blue-500 hover:text-blue-700 whitespace-no-wrap no-underline hover:underline ml-auto"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            >
                                ...
                                <a
                                    class="text-blue-500 hover:text-blue-700 no-underline hover:underline"
                                    href="{{ route('register') }}"
                                >
                                    {{ __("Register") }}
                                </a>
